...
export const COACH_REGISTRY: CoachConfig[] = [
  ...
  },
  {
    ...
    slugPatterns: ['stress', 'burnout', 'anxiety', 'depression', 'lifestyle', 'mental'],
    name: 'Scarlett',
    photo: 'https://files2.heygen.ai/avatar/v3/946f804908de47fda0b9bb71fc266e9e_39070/preview_talk_7.webp',
    gradientPhoto: 'bg-gradient-to-br from-violet-500/30 to-indigo-700/30',
    gradientCta:   'bg-gradient-to-r from-violet-500 to-indigo-600',
    roleColor:     'text-violet-300',
    borderColor:   'hover:border-violet-400/40',
    getRole: s => s.coachScarlettRole,
    getSpec: s => s.coachScarlettSpec,
    getCta:  s => s.coachTalkTo('Scarlett'),
    href:    lang => `/${lang}/coach/scarlett`,
  },
  {
    id: 'lina',
    clusters: ['nutrition', 'diet', 'lifestyle'],
    slugPatterns: ['calorie', 'calorie-deficit', 'tdee', 'bmr', 'hydration', 'nutrition', 'diet'],
    name: 'Lina',
    photo: 'https://files2.heygen.ai/avatar/v3/f362f513eb5241d795aa555d47e02db5_48370/preview_talk_2.webp',
    gradientPhoto: 'bg-gradient-to-br from-emerald-500/30 to-teal-700/30',
    gradientCta:   'bg-gradient-to-r from-emerald-500 to-teal-600',
    roleColor:     'text-emerald-300',
    borderColor:   'hover:border-emerald-400/40',
    getRole: s => s.coachLinaRole,
    getSpec: s => s.coachLinaSpec,
    getCta:  s => s.coachTalkTo('Lina'),
    href:    lang => `/${lang}/coach/lina`,
  },
  {
    id: 'emilia',
    clusters: ['energy', 'fitness', 'body'],
    slugPatterns: ['body-fat', 'ideal-weight', 'energy', 'bmi', 'weight-readiness', 'fitness'],
    name: 'Emilia',
    photo: 'https://files2.heygen.ai/avatar/v3/137d2a33e1d246fd8d528b3040f25714_38470/preview_target.webp',
    gradientPhoto: 'bg-gradient-to-br from-amber-500/30 to-orange-700/30',
    gradientCta:   'bg-gradient-to-r from-amber-500 to-orange-500',
    roleColor:     'text-amber-300',
    borderColor:   'hover:border-amber-400/40',
    getRole: s => s.coachEmiliaRole,
    getSpec: s => s.coachEmiliaSpec,
    getCta:  s => s.coachTalkTo('Emilia'),
    href:    lang => `/${lang}/coach/emilia`,
  },
  {
    id: 'marcus',
    clusters: ['investment', 'savings', 'retirement'],
    slugPatterns: ['compound-interest', 'investment', 'savings', 'retirement', 'compound'],
    name: 'Marcus',
    photo: 'https://files2.heygen.ai/avatar/v3/e2ebd7fc67994cf9870c8a2226ea2fef_45270/preview_talk_1.webp',
    gradientPhoto: 'bg-gradient-to-br from-sky-500/30 to-indigo-700/30',
    gradientCta:   'bg-gradient-to-r from-sky-400 to-indigo-600',
    roleColor:     'text-sky-300',
    borderColor:   'hover:border-sky-400/40',
    getRole: s => s.coachMarcusRole,
    getSpec: s => s.coachMarcusSpec,
    getCta:  s => s.coachTalkTo('Marcus'),
    href:    lang => `/${lang}/coach/marcus`,
  },
]
