...
import { getInstrument, getTranslations, getAllSlugs, SUPPORTED_LANGS, getAllInstrumentsLocalized } from '../../../lib/instruments'
...
export function generateMetadata({ params }: PageProps): Metadata {
  ...
  return {
    title: `${instrument.seoTitle} | CALCO`,
    ...
    openGraph: {
      title: `${instrument.seoTitle} | CALCO`,
      description: instrument.seoDescription,
      images: [`https://solviqlab.com/og/${params.slug}.png`],
      type: 'website',
    },
    twitter: {
...
export default function InstrumentPage({ params }: PageProps) {
  ...
  const breadcrumbSchema = {
    ...
    '@type': 'BreadcrumbList',
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: s.breadcrumbHome, item: `https://solviqlab.com/${lang}` },
      {
        '@type': 'ListItem',
        position: 2,
        name: catLabel,
