  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        tr: getInstrumentCanonical('tr', params.slug, instrument.category),
        it: getInstrumentCanonical('it', params.slug, instrument.category),
        nl: getInstrumentCanonical('nl', params.slug, instrument.category),
